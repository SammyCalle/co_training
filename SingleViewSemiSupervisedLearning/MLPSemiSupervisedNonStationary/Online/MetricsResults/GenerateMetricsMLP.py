...
with open("../YearExperimentResults/non_normal/optimized/OnlyModel/not_balanced/SystemCalls/models_X1.pkl", 'rb') as f:
    models_X1 = pickle.load(f)

with open("../YearExperimentResults/non_normal/optimized/OnlyModel/not_balanced/SystemCalls/models_X2.pkl", 'rb') as f:
...
with open("../YearExperimentResults/non_normal/optimized/OnlyModel/not_balanced/SystemCalls/metrics.pkl", "wb") as file:
