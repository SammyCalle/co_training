...
if __name__ == '__main__':
    ...
    with open("YearExperimentResults/Batch/non_normal/optimized/OnlyModel/not_balanced/Permisions/models_X1.pkl", "wb") as file:
        pickle.dump(dict_models_X1, file)

    with open("YearExperimentResults/Batch/non_normal/optimized/OnlyModel/not_balanced/Permisions/models_X2.pkl", "wb") as file:
