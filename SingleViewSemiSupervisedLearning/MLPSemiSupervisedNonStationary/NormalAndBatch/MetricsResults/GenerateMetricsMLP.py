...
with open("../YearExperimentResults/Batch/non_normal/optimized/OnlyModel/balanced/SystemCalls/models_X1.pkl", 'rb') as f:
    models_X1 = pickle.load(f)

with open("../YearExperimentResults/Batch/non_normal/optimized/OnlyModel/balanced/SystemCalls/models_X2.pkl", 'rb') as f:
...
with open("../YearExperimentResults/Batch/non_normal/optimized/OnlyModel/balanced/SystemCalls/metrics.pkl", "wb") as file:
