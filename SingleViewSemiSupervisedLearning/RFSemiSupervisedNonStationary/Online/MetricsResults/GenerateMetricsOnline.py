...
with open("../YearExperimentResults/non_normal/optimized/OnlyModel/not_balanced/Permisions/models_X1.pkl", 'rb') as f:
    models_X1 = pickle.load(f)

with open("../YearExperimentResults/non_normal/optimized/OnlyModel/not_balanced/Permisions/models_X2.pkl", 'rb') as f:
...
def generate_all_the_predictions_lists(data_list, models_X1, models_X2) -> []:
    ...
    for key in models_X1:
        generated_list = generate_prediction_list(model_x1=models_X1[key], model_x2=models_X2[key],
                                                  x1_test=permissions[key],
                                                  x2_test=system_calls[key], y=y[key])
...
with open("../YearExperimentResults/non_normal/optimized/OnlyModel/not_balanced/Permisions/metrics.pkl", "wb") as file:
