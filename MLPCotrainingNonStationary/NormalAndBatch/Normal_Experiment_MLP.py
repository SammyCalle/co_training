...
if __name__ == '__main__':
    ...
    with open("YearExperimentResults/Normal/non_normal/optimized/OnlyModel/balanced/models_X1.pkl", "wb") as file:
        pickle.dump(dict_models_X1, file)

    with open("YearExperimentResults/Normal/non_normal/optimized/OnlyModel/balanced/models_X2.pkl", "wb") as file:
