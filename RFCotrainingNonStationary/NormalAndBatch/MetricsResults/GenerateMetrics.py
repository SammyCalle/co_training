...
with open("../YearExperimentResults/Normal/standard_scaler/models_X1.pkl", 'rb') as f:
    models_X1 = pickle.load(f)

with open("../YearExperimentResults/Normal/standard_scaler/models_X2.pkl", 'rb') as f:
...
with open("../YearExperimentResults/Normal/standard_scaler/metrics.pkl", "wb") as file:
