...
with open("../RamdonForest/Online/Batch/balanced/permissions/metrics50.pkl", 'rb') as f:
    normal_balanced_permissions_50 = pickle.load(f)

with open("../RamdonForest/Online/Batch/balanced/systemcalls/metrics50.pkl", 'rb') as f:
    normal_balanced_system_calls_50 = pickle.load(f)

with open("../RamdonForest/Online/Batch/balanced/both/metrics50.pkl", 'rb') as f:
    normal_balanced_both_50 = pickle.load(f)

with open("../RamdonForest/Online/Batch/balanced/permissions/metrics75.pkl", 'rb') as f:
    normal_balanced_permissions_75 = pickle.load(f)

with open("../RamdonForest/Online/Batch/balanced/systemcalls/metrics75.pkl", 'rb') as f:
    normal_balanced_system_calls_75 = pickle.load(f)

with open("../RamdonForest/Online/Batch/balanced/both/metrics75.pkl", 'rb') as f:
...
accuracy_df = pd.concat([normal_balanced_permissions_50['Accuracy'],
                         ...
                         normal_balanced_both_75['Accuracy']], axis=1)
...
precision_df = pd.concat([normal_balanced_permissions_50['Precision'],
                         ...
                         normal_balanced_both_75['Precision']], axis=1)
...
recall_df = pd.concat([normal_balanced_permissions_50['Recall'],
                         ...
                         normal_balanced_both_75['Recall']], axis=1)
...
f1_df = pd.concat([normal_balanced_permissions_50['F1'],
                         ...
                         normal_balanced_both_75['F1']], axis=1)
